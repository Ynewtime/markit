...
const en = {
  ...
  helpCloudflareUrl: "Send URLs to Cloudflare Browser Rendering with configured account credentials, also selecting Cloudflare file conversion.",
  ...
  helpKreuzberg: "Convert supported files locally on the server with the optional Kreuzberg package and its dependencies.",
  helpCloudflareFile: "Upload files to Cloudflare Workers AI toMarkdown with configured account credentials, potentially consuming image-conversion quota.",
  ...
  helpCli: "Replace the input placeholder with your own paths or URLs, using default CLI settings and matching server presets.",
  ...
  noticeCloudflareFile: "Supported file contents are uploaded to Cloudflare Workers AI toMarkdown.",
  ...
  advanced: "Advanced",
  options: "Options",
  optionsChanged: "options in effect",
  advEnhance: "Enhance",
  advOutput: "Output",
  advImages: "Images",
  advAlt: "alt text",
  ...
  advPure: "plain mode",
  advPureHint: "Skip normal metadata and image post-processing.",
  advFetch: "Fetch",
  advStrategy: "URL",
  advBackend: "Files",
  advOther: "Other",
  advNoCache: "skip cache",
  advNoCacheHint: "Process afresh instead of reusing cached results, possibly adding model costs.",
...
const zh: Dict = {
  ...
  helpCloudflareUrl: "使用已配置的账户凭据将 URL 发送到 Cloudflare Browser Rendering，同时启用 Cloudflare 文件转换。",
  helpBackend: "选择文件转换方式，与网页提取和模型连接分开设置。",
  helpNative: "使用服务端已安装的格式转换工具处理文件，不将文件上传到转换服务。",
  helpKreuzberg: "使用可选的 Kreuzberg 包及其依赖，在服务端本地转换支持的文件。",
  helpCloudflareFile: "使用已配置的账户凭据将文件上传到 Cloudflare Workers AI toMarkdown，图片转换可能消耗配额。",
  ...
  helpCli: "将输入占位符替换为自己的路径或 URL，并确保 CLI 使用默认设置且预设与服务端一致。",
  ...
  noticeCloudflareFile: "支持的文件内容将上传到 Cloudflare Workers AI toMarkdown。",
  ...
  advPure: "纯净模式",
  advPureHint: "跳过常规元数据与图片后处理。",
  advFetch: "抓取",
  advStrategy: "URL",
  advBackend: "文件",
  advOther: "其它",
  advNoCache: "不用缓存",
  advNoCacheHint: "重新处理而不复用缓存结果，可能增加模型费用。",
  advNoCompress: "不压缩图片",
  profile: "输出格式",
  profileNone: "默认",
  llmEnhance: "LLM 增强",
