...
const en = {
  ...
  preset: "Preset",
  advanced: "Advanced",
  advancedChanged: "changed from defaults",
  advImages: "Images",
  advAlt: "alt text",
  advDesc: "description JSON",
  advScreenshot: "page screenshots",
  advNeedsLlm: "needs LLM enhancement",
  advImpliedBySource: "always on when reading from screenshots",
  advSource: "Source",
  advScreenshotOnly: "read from screenshots",
  advScreenshotOnlyHint: "Use the rendered page as the content, not its text layer",
  advPure: "plain mode",
  advPureHint: "Skip frontmatter and post-processing",
  advFetch: "Fetch",
  advStrategy: "URL",
  advBackend: "files",
  advOther: "Other",
  advNoCache: "skip cache",
  advNoCacheHint: "Force fresh LLM calls instead of reusing an earlier answer",
...
const zh: Dict = {
  ...
  preset: "预设",
  advanced: "高级",
  advancedChanged: "已偏离默认",
  advImages: "图片",
  advAlt: "alt 文本",
  advDesc: "描述 JSON",
  advScreenshot: "页截图",
  advNeedsLlm: "需要开启 LLM 增强",
  advImpliedBySource: "以截图为内容源时始终开启",
  advSource: "内容源",
  advScreenshotOnly: "仅用截图",
  advScreenshotOnlyHint: "以渲染出的页面作为内容，而非其文本层",
  advPure: "纯净模式",
  advPureHint: "跳过 frontmatter 与后处理",
  advFetch: "抓取",
  advStrategy: "URL",
  advBackend: "文件",
  advOther: "其它",
  advNoCache: "不用缓存",
  advNoCacheHint: "强制发起新的 LLM 调用，而不复用此前的答案",
  advNoCompress: "不压缩图片",
  profile: "输出格式",
  profileNone: "默认",
  llmEnhance: "LLM 增强",
